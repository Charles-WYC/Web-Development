             ...
             <tr>
                 <td>
                     <form action="editUserInfo" method="post">
						<label><span>用户ID：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${user.userID}</span></label><input type="hidden" name="userID" value="${user.userID }"> <br>
                        <p>
						<label><span>用户名：&nbsp;&nbsp;&nbsp;&nbsp;</span></label><input type="text" name="username" value="${user.username }"> <br> 
                        <p>
